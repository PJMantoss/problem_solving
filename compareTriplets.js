...
from 1 to 3 for three categories: problem clarity, originality, and difficulty.

We define the rating for Alice's challenge to be the triplet a = [1,2,3], 
and the rating for Bob's challenge to be the triplet b = [3,2,1].
...
a point because a[0] < b[0]. For the equal elements 1 and 1, no points are earned. 
Finally, for elements 2,  so Alice receives a point. Your return array would be  
